...
if (isset($_POST['strangerLightsB']))
{
exec('sudo python /var/www/gpio/strangerlights.py');
}
if (isset($_POST['strangerLightsB']))
{
exec('sudo python /var/www/gpio/custom.py');
...
<tr>
  ...
  <tr>
	<td style="text-align: center;"><button name="strangerLightsB">strangerLights </button></td>
